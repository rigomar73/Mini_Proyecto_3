...
public class ElementPokemon {
    ...
    // Inicializa los ataques de cada tipo
    ...
    // Inicializa los Pokémon con sus estadísticas y ataques
    ...
    // Inicializa todos los datos (ataques y Pokémon)
    public static void initializeData() {
        initializeMoves();
        initializePokemons();
    }

    // Método para crear ataques personalizados (opcional)
    ...
    // Devuelve una lista mutable de Pokémon
    public static ArrayList<Pokemon> getPokemonList() {
        return new ArrayList<>(List.of(getPokemons()));
    }
}